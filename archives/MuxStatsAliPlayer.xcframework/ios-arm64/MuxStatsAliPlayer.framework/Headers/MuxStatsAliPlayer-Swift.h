...
#ifndef MUXSTATSALIPLAYER_SWIFT_H
#define MUXSTATSALIPLAYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MuxStatsAliPlayer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17MuxStatsAliPlayer21AliPlayerControlsView")
@interface AliPlayerControlsView : UIView
@property (nonatomic, strong) UISlider * _Null_unspecified progressSlider;
...
@interface AliPlayerControlsView (SWIFT_EXTENSION(MuxStatsAliPlayer))
- (void)setProgressValueWithPosition:(int64_t)position;
- (void)play;
- (void)pause;
- (void)stop;
- (void)replay;
...
SWIFT_CLASS("_TtC17MuxStatsAliPlayer10PlayerBase")
...
SWIFT_CLASS("_TtC17MuxStatsAliPlayer16MLYAliListPlayer")
@interface MLYAliListPlayer : PlayerBase
@property (nonatomic, strong) AliListPlayer * _Null_unspecified listPlayer;
@property (nonatomic, copy) NSArray<MLYUrlSource *> * _Nullable urlSources;
- (nonnull instancetype)initWithView:(UIView * _Null_unspecified)view playerView:(UIView * _Null_unspecified)playerView videoURLs:(NSArray<NSString *> * _Null_unspecified)videoURLs OBJC_DESIGNATED_INITIALIZER;
- (MLYMuxModel * _Nonnull)getMuxConfigModel SWIFT_WARN_UNUSED_RESULT;
@end

@class AliPlayer;

SWIFT_CLASS("_TtC17MuxStatsAliPlayer12MLYAliPlayer")
@interface MLYAliPlayer : PlayerBase
@property (nonatomic, strong) AliPlayer * _Null_unspecified player;
@property (nonatomic, strong) AliPlayerControlsView * _Nullable controlsView;
@property (nonatomic, copy) NSString * _Nullable videoURL;
- (nonnull instancetype)initWithView:(UIView * _Nonnull)view playerView:(UIView * _Nonnull)playerView videoURL:(NSString * _Nonnull)videoURL OBJC_DESIGNATED_INITIALIZER;
- (MLYMuxModel * _Nonnull)getMuxConfigModel SWIFT_WARN_UNUSED_RESULT;
@end



@interface MLYAliPlayer (SWIFT_EXTENSION(MuxStatsAliPlayer)) <AVPDelegate>
- (void)onCurrentPositionUpdate:(AliPlayer * _Null_unspecified)player position:(int64_t)position;
@end



SWIFT_CLASS("_TtC17MuxStatsAliPlayer11MLYMuxModel")
@interface MLYMuxModel : NSObject
@property (nonatomic, weak) id <AVPDelegate> _Nullable delegate;
@property (nonatomic, weak) AliPlayer * _Nullable player;
@property (nonatomic, copy) NSString * _Nullable videoURL;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC17MuxStatsAliPlayer12MLYUrlSource")
@interface MLYUrlSource : NSObject
...
- (void)removeDataForPlayerName:(NSString * _Nonnull)name;
- (MUXSDKCustomerVideoData * _Nullable)videoDataForPlayerName:(NSString * _Nonnull)name SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)removeDataForPlayerName:(NSString * _Nonnull)name;
- (MUXSDKCustomerViewData * _Nullable)viewDataForPlayerName:(NSString * _Nonnull)name SWIFT_WARN_UNUSED_RESULT;
@end
